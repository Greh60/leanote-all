...
* `Vim` и `Emacs` подобные режимы редактирования
* Экспорт заметок в PDF
* Batch note operation
* Настраиваемые темы для блогов

## 2. Почему мы создали Leanote
...
Заинтересованы в нашем продукте и хотите попробовать его в своем веб-браузере? Зарегистрируйтесь на https://leanote.com.
...
Более подробную информацию об установке можно посмотреть по этим ссылкам:

* Руководство по установке скомпилированного Leanote:
...
* Руководство по установке Leanote из исходных кодов:
    * [Windows](https://github.com/leanote/leanote/wiki/leanote-source-installation-on-Windows-(En))
    * [Mac and Linux](https://github.com/leanote/leanote/wiki/Leanote-source-installation-on-Mac-and-Linux-(En))

## 4. Документация

Пожалуйста смотрите [wiki](https://github.com/leanote/leanote/wiki) для подробной инструкции о том как установить Leanote на различные платформы, устранении неполадок и конфигурации.


## 5. Как принять участие в разработке Leanote
